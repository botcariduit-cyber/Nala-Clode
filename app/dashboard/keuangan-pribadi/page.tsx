...
export default async function KeuanganPribadiPage() {
  ...
  return (
    <div className="px-8 py-8 max-w-[1000px]">
      ...
      <p className="text-[#8B8AA0] mb-8">Gaji, belanja, dan tagihan pribadi kamu.</p>
      ...
      <div className="grid md:grid-cols-[320px_1fr] gap-6">
        <TransactionForm userId={user!.id} scope="pribadi" />
        ...
        <div className="bg-[#0F0F1A] border border-white/10 rounded-2xl p-5">
          ...
          <div className="flex flex-col gap-3">
            {transactions && transactions.length > 0 ? (
              ...
              <p className="text-sm text-[#8B8AA0]">Belum ada transaksi pribadi.</p>
            )}
          </div>
        </div>
      </div>
