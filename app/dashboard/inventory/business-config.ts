...
export const businessConfig: Record<string, BusinessConfig> = {
  ...
  pertanian: {
    ...
    alasanKeluar: [
      ...
      { value: "terpakai", label: "Terpakai sendiri" },
      { value: "lainnya", label: "Lainnya" },
    ],
    kategoriDefault: ["Padi", "Sayuran", "Buah", "Palawija", "Pupuk", "Pestisida", "Bibit", "Peralatan"],
    kpiLabel: { total: "Total item", lowStock: "Stok kritis", nilai: "Nilai stok", rataHarga: "Rata-rata harga" },
  },
  bengkel: {
